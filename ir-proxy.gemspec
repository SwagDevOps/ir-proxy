...
Gem::Specification.new do |s|
  ...
  s.files         = [
    ...
    "lib/ir_proxy/cli/command/configurable.rb",
    "lib/ir_proxy/cli/command/container_aware.rb",
    "lib/ir_proxy/cli/command/eventable.rb",
    "lib/ir_proxy/cli/command/processable.rb",
